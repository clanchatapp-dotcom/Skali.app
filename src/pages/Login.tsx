    ...
    <div className="min-h-full grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-sm bg-panel/80 backdrop-blur border border-edge rounded-3xl p-8 shadow-2xl shadow-black/50">
          ...
          <p className="text-[11px] text-slate-500 mt-6 text-center leading-relaxed" data-testid="login-legal-links">
            By continuing you agree to our{' '}
            <Link to="/legal/terms" className="text-slate-400 hover:text-brand underline">Terms</Link>,{' '}
            <Link to="/legal/privacy" className="text-slate-400 hover:text-brand underline">Privacy Policy</Link>,{' '}
            <Link to="/legal/content" className="text-slate-400 hover:text-brand underline">Content Policy</Link>{' '}and{' '}
            <Link to="/legal/cookies" className="text-slate-400 hover:text-brand underline">Cookie Policy</Link>.
          </p>
        </div>
      </div>
    </div>
